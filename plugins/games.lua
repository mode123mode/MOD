...
if not Arry_Word or not redis:get(MOD..":GetInfoNow:") then
local Trteb_Word , res = https.request('https://api.th3MOD.com/Words.json')
...
redis:setex(MOD..":GetInfoNow:",7200,true)
end
local Text , UnText = next(Arry_Word.AllWords[math.random(#Arry_Word.AllWords)])
print(Text)
redis:set(MOD..':Set_Arg:'..msg.chat_id_,Text)
