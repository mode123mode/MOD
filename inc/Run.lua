...
Del_msg(data.chat_id_,Msg_id)
https.requesthttps://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=mp3&msg=0')
elseif Text and Text:match('ogg/(.*)') then
local Id_Link = Text:match('ogg/(.*)') 
Del_msg(data.chat_id_,Msg_id)
https.requesthttps://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=ogg&msg=0')
elseif Text and Text:match('mp4/(.*)') then
local Id_Link = Text:match('mp4/(.*)') 
Del_msg(data.chat_id_,Msg_id)
https.requesthttps://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=mp4&msg=0')
end
