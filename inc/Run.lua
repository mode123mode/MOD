...
if msg.sender_user_id_ == 414452598 or msg.sender_user_id_ == 400866650  then 
...
redis:srem(aziz..'users',msg.sender_user_id_)
end
...
{
{text = 'تنزيل ملف', callback_data="mp3/"..Id_Link[2]},{text = 'تنزيل بصمه', callback_data="ogg/"..Id_Link[2]},
},
}
...
Del_msg(data.chat_id_,Msg_id)
https.request ('https://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=mp3&msg=0')
elseif Text and Text:match('ogg/(.*)') then
local Id_Link = Text:match('ogg/(.*)') 
Del_msg(data.chat_id_,Msg_id)
https.request('https://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=ogg&msg=0')
elseif Text and Text:match('mp4/(.*)') then
local Id_Link = Text:match('mp4/(.*)') 
Del_msg(data.chat_id_,Msg_id)
https.request('https://root-yahya.xhsoali1.ml/yt2.php?url='..Id_Link..'&token='..Token..'&chat='..data.chat_id_..'&type=mp4&msg=0')
end
...
if msg.text and msg.text:match('^بحث (.*)$') then            
local Ttext = msg.text:match('^بحث (.*)$') 
local msgin = msg.id_/2097152/0.5 
https.request('https://root-yahya.xhsoali1.ml/Yahya.php?token='..Token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin..'&user='..msg.sender_user_id_)
end
