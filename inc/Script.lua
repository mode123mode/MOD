...
redis:hset(MOD..'CmD:'..msg.chat_id_,'م','مميز')
redis:sadd(MOD..'CmDlist:'..msg.chat_id_,"اد")
redis:hset(MOD..'CmD:'..msg.chat_id_,'اد','ادمن')
redis:sadd(MOD..'CmDlist:'..msg.chat_id_,"مد")
redis:hset(MOD..'CmD:'..msg.chat_id_,'مد','مدير')
redis:sadd(MOD..'CmDlist:'..msg.chat_id_,"من")
redis:hset(MOD..'CmD:'..msg.chat_id_,'من','منشئ')
redis:sadd(MOD..'CmDlist:'..msg.chat_id_,"اس")
redis:hset(MOD..'CmD:'..msg.chat_id_,'اس','المنشئ الاساسي ')
redis:sadd(MOD..'CmDlist:'..msg.chat_id_,"تعط")
redis:hset(MOD..'CmD:'..msg.chat_id_,'تعط','تطيل الايدي بالصوره')
...
redis:hset(MOD..'CmD:'..msg.chat_id_,'تك','تنزيل الكل')
...
redis:hset(MOD..'CmD:'..msg.chat_id_,'ت','تثببت')
